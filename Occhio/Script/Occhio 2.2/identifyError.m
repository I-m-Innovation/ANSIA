...
opt=detectImportOptions("dati/Database_Produzione/ErrorList3.csv");
List=readtable("dati/Database_Produzione/ErrorList3.csv","VariableNamingRule","preserve");
cd(ftpobj,"dati/Database_Produzione");


if FuncName=="processST" || FuncName=="uploadSTData"
