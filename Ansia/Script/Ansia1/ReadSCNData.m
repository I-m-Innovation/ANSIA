...
if month(Today)>9
    Today_00=posixtime(datetime(day(Today)+"/"+month(Today)+"/"+year(Today)+" 00:00",'InputFormat','dd/MM/uuuu HH:mm'));
else
    Today_00=posixtime(datetime(day(Today)+"/0"+month(Today)+"/"+year(Today)+" 00:00","InputFormat","dd/MM/uuuu HH:mm"));
