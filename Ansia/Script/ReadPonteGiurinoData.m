...
% opts = detectImportOptions("dati/ponte_giurino/DBPGNEW.csv")
% opts = setvartype(opts, "x__TimeStamp", 'string');

ST_tab=readtable("dati/ponte_giurino/DBPGNEW.csv");
ST_Time=datetime(ST_tab.x__TimeStamp,'InputFormat','dd/MM/uuuu hh:mm:ss');
ST_Time = ST_Time + hours(1);
...
Today=datetime("today","Format","dd/MM/uuuu")-'01:00:00';
