function     Data=process3F(app,Plant)
...
try
    if app.Resize == 0
        ...
        try
            Data = upload3FData(app);
        catch err

            try

                Recipients="stefano.trevisan@zilioservice.com";
                TEXT="Errore in 'upload3FData()'"+newline+string(err.message);
%                 sendmail2(Recipients,"viviL'OCCHIO: problema nell'upload dei dati",TEXT{:});
        ...
        try
            plotPV3F(app,Data,Plant,isEmpty);

        catch err

            Recipients="stefano.trevisan@zilioservice.com";
            TEXT="Errore in 'plotPV(app,Data)'"+newline+string(err.message);
%             sendmail2(Recipients,"viviL'OCCHIO: problema nel plot dei dati",TEXT{:});
        ...
        try
            ...
            plotPV3F(app,app.CurrData,Plant,isEmpty);

        catch err

            Recipients="stefano.trevisan@zilioservice.com";
            TEXT="Errore in 'plotPV(app,app.CurrData)'"+newline+string(err.message);
%             sendmail2(Recipients,"viviL'OCCHIO: problema nel Replot dei dati",TEXT{:});
        end
