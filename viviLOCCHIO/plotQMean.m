...
if app.MediaAnnualeCheckBox.Value==1
    ...
    legend(app.Graph,{'Potenza istantanea','Potenza media','Portata istantanea','Portata media','Portata concessa','Portata Media 2022'},'location','best','Orientation','vertical', 'FontSize',10);
