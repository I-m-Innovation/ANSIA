function    plotPV(app,Data,Plant,isEmpty)
if isEmpty==0
...
try
    ...
    hGraph=max([plot1.YData,plot2.YData])+10;
    hold(app.Graph,'on');
    ...
    legend(app.Graph,{'Potenza AC','Irraggiamento'},'location','Best','FontSize',10,'Location','NorthEast');
